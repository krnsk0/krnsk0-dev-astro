...
<div class="skyscraper_grid large">
    <div>
      <div></div>
      <div></div>
      <div></div>
...
Though trivial, sequence filtration also captures what happens in our second example:
...
<div class="skyscraper_grid small">
    <div>
      <div></div>
      <div></div>
      <div></div>
...
<div class="skyscraper_grid huge">
    <div>
      <div> </div>
      <div>3</div>
      <div>3</div>
